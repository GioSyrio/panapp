...
BIOLOGY_GROUPS = [
    ("DNA|RNA|νουκλε|γονίδιο|γενετικ|μεταγραφή|μετάφραση|αντιγραφή|κώδικ|χρωμόσωμ|καρυό|αντιγραφ|πυρην|νουκλεό", "Γενετικό Υλικό — DNA/RNA"),
    ("κύτταρ|κυτταρ|μεμβράν|οργανίδ|μιτοχόνδ|χλωροπλ|ενδοπλασμ|ριβόσωμ|πλασμίδ|κυτταροπλ|γενετικ|υλικ|κάρυ|πυρην", "Κύτταρο & Οργανίδια"),
    ("πρωτεΐν|αμινοξ|ένζυμ|σύνθεση|δομή|βιοσύνθεση|πεπτιδ|δεσμ|στερεοδιάτ|διαμόρφωση", "Πρωτεΐνες & Ένζυμα"),
    ("μίτωση|μείωση|διαίρεση|κυτταρικ κύκλ|μεσόφαση|γαμέτ|σπερματογ|ωογέν|αναπαραγωγ", "Κυτταρική Διαίρεση — Μίτωση/Μείωση"),
    ...
    ("νευρικ|νευρών|σύναψη|ορμόνη|ενδοκριν|αδένα|υποθάλαμ|υπόφυσ|συνάψ|μεταβιβαστ|θυρεοειδ|ινσουλ|γλυκαγ|γαλακτ", "Νευρικό & Ενδοκρινικό Σύστημα"),
    ("ανοσο|αντισώμ|λεμφοκύτ|ανοσία|εμβόλ|αντιγόν|μακροφάγ|ανοσοπ|αυτοάν|αλλεργ", "Ανοσοποιητικό Σύστημα"),
    ("ιός|βακτήρ|μικροοργ|παθογόν|μόλυνσ|λοίμωξ|ανθεκτ|αντιβι|φάρμακ|μύκητ|πρωτόζ", "Μικροοργανισμοί & Λοιμώξεις"),
    ("βιοτεχν|γενετικ|μηχανικ|κλωνοπ|ανασυνδυασμ|PCR|ηλεκτροφόρ|διαγονιδ|αλυσιδ|φορέα|πλασμ", "Βιοτεχνολογία & Γενετική Μηχανική"),
    ("κληρονομ|φαινότυπ|γονότυπ|επικρατ|υπολειπ|αυτοσωμ|φυλοσύνδ|γενεαλ|ομάδ|αίματ|φυλ|ασθέν|νόσημ|διασταύρ", "Κληρονομικότητα"),
    ("πέψη|πεπτικ|γαστρεν|στομάχι|έντερο|απορρόφ|πεπτ|στομαχ|γαστρ", "Πεπτικό Σύστημα"),
    ("εξέλικ|φυσικ επιλογ|Δαρβίν|προσαρμογ|ειδογέν|απολίθ|φυλογεν|ταξινομ|συνθετικ θεω|εξελιξ", "Εξέλιξη"),
