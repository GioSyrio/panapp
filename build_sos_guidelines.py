...
BIOLOGY_GROUPS = [
    ("DNA|RNA|νουκλε|γονίδιο|γενετικ|μεταγραφή|μετάφραση|αντιγραφή|κώδικα|χρωμόσωμ|καρυό", "Γενετικό Υλικό — DNA/RNA"),
    ("κύτταρ|κυτταρικ|μεμβράν|οργανίδ|μιτοχόνδ|χλωροπλ|ενδοπλασμ|ριβόσωμ|πλασμίδ", "Κύτταρο & Οργανίδια"),
    ("πρωτεΐν|αμινοξ|ένζυμ|σύνθεση|δομή|βιοσύνθεση", "Πρωτεΐνες & Ένζυμα"),
    ("μίτωση|μείωση|διαίρεση|κυτταρικός κύκλ|μεσόφαση|γαμέτ", "Κυτταρική Διαίρεση — Μίτωση/Μείωση"),
    ("μεταβολισμ|αναπνοή|γλυκόλυση|Krebs|ATP|φωτοσύνθεση|χημειοσύνθεση|φωτεινή|Calvin|οξειδωτικ", "Μεταβολισμός — Αναπνοή & Φωτοσύνθεση"),
    ("οικολ|οικοσύστημ|τροφικ|πληθυσμ|βιοποικιλ|ρύπαν|διαχείρ", "Οικολογία & Οικοσυστήματα"),
    ("νευρικ|νευρών|σύναψη|ορμόνη|ενδοκριν|αδένα|υποθάλαμ|υπόφυσ", "Νευρικό & Ενδοκρινικό Σύστημα"),
    ("ανοσο|αντισώμ|λεμφοκύτ|ανοσία|εμβόλ|αντιγόν|μακροφάγ", "Ανοσοποιητικό Σύστημα"),
    ("ιός|βακτήρ|μικροοργ|παθογόν|μόλυνσ|λοίμωξ", "Μικροοργανισμοί & Λοιμώξεις"),
    ("βιοτεχν|γενετικ|μηχανικ|κλωνοπ|ανασυνδυασμ|PCR|ηλεκτροφόρ|διαγονιδ", "Βιοτεχνολογία & Γενετική Μηχανική"),
    ("κληρονομ|φαινότυπ|γονότυπ|επικρατ|υπολειπ|αυτοσωμ|φυλοσύνδ", "Κληρονομικότητα"),
    ("πέψη|πεπτικ|γαστρεν|στομάχι|έντερο|απορρόφ", "Πεπτικό Σύστημα"),
    ("εξέλικ|φυσική επιλογή|Δαρβίν|προσαρμογ|ειδογέν|απολίθ", "Εξέλιξη"),
]
